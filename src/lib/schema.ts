import { pgTable, unique, pgEnum, uuid, timestamp, text, smallint, boolean, bigint } from "drizzle-orm/pg-core"
...
export const profiles = pgTable("profiles", {
	...
	createdAt: timestamp("created_at", { withTimezone: true, mode: 'string' }).default(new Date().toString()),
	email: text("email"),
