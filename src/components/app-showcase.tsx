...
function AppShowcase() {
  return (
    <div className="relative flex size-full flex-col justify-around overflow-hidden rounded-lg border lg:flex-row">
      <AppShowcaseBg />
      <div className="z-20 flex h-full max-w-full items-center justify-around overflow-x-hidden p-2 lg:w-1/2">
      ...
      <div className="z-20 flex flex-col justify-between py-2 lg:w-1/2">
        ...
        <a
          ...
          className="mx-auto mb-5 h-16 w-3/4 lg:mx-0"
        >
          <Button className="download-button size-full cursor-pointer gap-3 bg-green-500 text-xl font-bold duration-200 hover:bg-green-600 lg:bg-green-700">
            Download
