...
export function MainContributors(props: MainContributors) {
    return (
        <div className="flex h-[170px] w-[500px] max-w-full items-center justify-around rounded-xl border bg-background px-3">
            <Avatar className="mx-2 h-32 w-32 rounded-full bg-secondary">
                <AvatarImage
