...
const Schema: z.ZodType<Prisma.instituteUncheckedCreateWithoutAccount_account_instituteToinstituteInput> =
  z
    .object({
...
export const instituteUncheckedCreateWithoutAccount_account_instituteToinstituteInputObjectSchema =
  Schema
