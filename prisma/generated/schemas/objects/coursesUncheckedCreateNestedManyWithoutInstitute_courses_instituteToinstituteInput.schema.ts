...
const Schema: z.ZodType<Prisma.coursesUncheckedCreateNestedManyWithoutInstitute_courses_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const coursesUncheckedCreateNestedManyWithoutInstitute_courses_instituteToinstituteInputObjectSchema =
  Schema
