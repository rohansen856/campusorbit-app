...
const Schema: z.ZodType<Prisma.routineUncheckedUpdateManyWithoutCoursesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => routineUpdateManyWithWhereWithoutCoursesInputObjectSchema
          ),
          z
            .lazy(
              () => routineUpdateManyWithWhereWithoutCoursesInputObjectSchema
...
export const routineUncheckedUpdateManyWithoutCoursesNestedInputObjectSchema =
  Schema
