...
const Schema: z.ZodType<Prisma.profileUncheckedUpdateWithoutAnalyticsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const profileUncheckedUpdateWithoutAnalyticsInputObjectSchema = Schema
