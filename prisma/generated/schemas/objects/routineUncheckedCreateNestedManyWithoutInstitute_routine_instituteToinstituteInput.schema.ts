...
const Schema: z.ZodType<Prisma.routineUncheckedCreateNestedManyWithoutInstitute_routine_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const routineUncheckedCreateNestedManyWithoutInstitute_routine_instituteToinstituteInputObjectSchema =
  Schema
