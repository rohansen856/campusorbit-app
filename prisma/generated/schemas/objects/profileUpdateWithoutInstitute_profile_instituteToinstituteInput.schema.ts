...
const Schema: z.ZodType<Prisma.profileUpdateWithoutInstitute_profile_instituteToinstituteInput> =
  z
    .object({
      username: z
        .union([
      ...
      electives: z
        ...
        .optional(),
      analytics: z
        .lazy(() => analyticsUpdateOneWithoutProfileNestedInputObjectSchema)
        .optional(),
      ...
      account: z
        .lazy(
          () => accountUpdateOneRequiredWithoutProfileNestedInputObjectSchema
        )
        .optional(),
    })
    .strict()

export const profileUpdateWithoutInstitute_profile_instituteToinstituteInputObjectSchema =
  Schema
