...
const Schema: z.ZodType<Prisma.profileUncheckedCreateWithoutInstitute_profile_instituteToinstituteInput> =
  z
    .object({
      id: z.string(),
...
export const profileUncheckedCreateWithoutInstitute_profile_instituteToinstituteInputObjectSchema =
  Schema
