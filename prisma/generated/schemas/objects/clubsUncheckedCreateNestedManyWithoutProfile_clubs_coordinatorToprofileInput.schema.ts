...
const Schema: z.ZodType<Prisma.clubsUncheckedCreateNestedManyWithoutProfile_clubs_coordinatorToprofileInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsUncheckedCreateNestedManyWithoutProfile_clubs_coordinatorToprofileInputObjectSchema =
  Schema
