...
const Schema: z.ZodType<Prisma.profileUpdateManyWithoutInstitute_profile_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const profileUpdateManyWithoutInstitute_profile_instituteToinstituteNestedInputObjectSchema =
  Schema
