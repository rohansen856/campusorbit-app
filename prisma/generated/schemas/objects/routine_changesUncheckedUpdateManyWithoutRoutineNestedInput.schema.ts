...
const Schema: z.ZodType<Prisma.routine_changesUncheckedUpdateManyWithoutRoutineNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const routine_changesUncheckedUpdateManyWithoutRoutineNestedInputObjectSchema =
  Schema
