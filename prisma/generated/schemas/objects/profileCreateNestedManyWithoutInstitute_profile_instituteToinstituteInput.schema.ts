...
const Schema: z.ZodType<Prisma.profileCreateNestedManyWithoutInstitute_profile_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const profileCreateNestedManyWithoutInstitute_profile_instituteToinstituteInputObjectSchema =
  Schema
