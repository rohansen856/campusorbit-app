...
const Schema: z.ZodType<Prisma.accountUncheckedUpdateWithoutRoutine_changesInput> =
  z
    .object({
      id: z
        .union([
...
export const accountUncheckedUpdateWithoutRoutine_changesInputObjectSchema =
  Schema
