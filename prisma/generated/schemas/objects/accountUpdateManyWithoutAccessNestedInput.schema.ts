...
const Schema: z.ZodType<Prisma.accountUpdateManyWithoutAccessNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => accountUpdateManyWithWhereWithoutAccessInputObjectSchema),
        z
          .lazy(() => accountUpdateManyWithWhereWithoutAccessInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const accountUpdateManyWithoutAccessNestedInputObjectSchema = Schema
