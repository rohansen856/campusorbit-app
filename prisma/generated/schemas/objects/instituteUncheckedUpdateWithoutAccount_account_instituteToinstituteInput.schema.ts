...
const Schema: z.ZodType<Prisma.instituteUncheckedUpdateWithoutAccount_account_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
...
export const instituteUncheckedUpdateWithoutAccount_account_instituteToinstituteInputObjectSchema =
  Schema
