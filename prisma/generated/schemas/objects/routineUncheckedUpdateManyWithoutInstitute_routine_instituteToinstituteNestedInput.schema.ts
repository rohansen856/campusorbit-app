...
const Schema: z.ZodType<Prisma.routineUncheckedUpdateManyWithoutInstitute_routine_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const routineUncheckedUpdateManyWithoutInstitute_routine_instituteToinstituteNestedInputObjectSchema =
  Schema
