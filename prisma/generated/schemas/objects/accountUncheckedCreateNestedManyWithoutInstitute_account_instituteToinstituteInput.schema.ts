...
const Schema: z.ZodType<Prisma.accountUncheckedCreateNestedManyWithoutInstitute_account_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const accountUncheckedCreateNestedManyWithoutInstitute_account_instituteToinstituteInputObjectSchema =
  Schema
