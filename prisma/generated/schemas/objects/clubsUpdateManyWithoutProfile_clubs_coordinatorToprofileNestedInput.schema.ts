...
const Schema: z.ZodType<Prisma.clubsUpdateManyWithoutProfile_clubs_coordinatorToprofileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsUpdateManyWithoutProfile_clubs_coordinatorToprofileNestedInputObjectSchema =
  Schema
