...
const Schema: z.ZodType<Prisma.clubsUpdateManyWithoutInstitute_clubs_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsUpdateManyWithoutInstitute_clubs_instituteToinstituteNestedInputObjectSchema =
  Schema
