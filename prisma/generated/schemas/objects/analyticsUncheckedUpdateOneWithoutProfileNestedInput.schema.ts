...
const Schema: z.ZodType<Prisma.analyticsUncheckedUpdateOneWithoutProfileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const analyticsUncheckedUpdateOneWithoutProfileNestedInputObjectSchema =
  Schema
