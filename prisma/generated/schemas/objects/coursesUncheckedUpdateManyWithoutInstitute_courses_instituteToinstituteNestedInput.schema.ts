...
const Schema: z.ZodType<Prisma.coursesUncheckedUpdateManyWithoutInstitute_courses_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const coursesUncheckedUpdateManyWithoutInstitute_courses_instituteToinstituteNestedInputObjectSchema =
  Schema
