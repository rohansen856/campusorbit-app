...
const Schema: z.ZodType<Prisma.profileUpdateWithoutClubs_clubs_cocoordinatorToprofileInput> =
  z
    .object({
      username: z
        .union([
...
export const profileUpdateWithoutClubs_clubs_cocoordinatorToprofileInputObjectSchema =
  Schema
