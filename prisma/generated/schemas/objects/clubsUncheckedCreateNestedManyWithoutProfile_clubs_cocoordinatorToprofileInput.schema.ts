...
const Schema: z.ZodType<Prisma.clubsUncheckedCreateNestedManyWithoutProfile_clubs_cocoordinatorToprofileInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsUncheckedCreateNestedManyWithoutProfile_clubs_cocoordinatorToprofileInputObjectSchema =
  Schema
