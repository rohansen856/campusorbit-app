...
const Schema: z.ZodType<Prisma.accountUncheckedUpdateManyWithoutInstitute_account_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const accountUncheckedUpdateManyWithoutInstitute_account_instituteToinstituteNestedInputObjectSchema =
  Schema
