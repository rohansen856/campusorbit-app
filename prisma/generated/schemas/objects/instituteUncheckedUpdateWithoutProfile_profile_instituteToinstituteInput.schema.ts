...
import { coursesUncheckedUpdateManyWithoutInstitute_courses_instituteToinstituteNestedInputObjectSchema } from "./coursesUncheckedUpdateManyWithoutInstitute_courses_instituteToinstituteNestedInput.schema"
...
const Schema: z.ZodType<Prisma.instituteUncheckedUpdateWithoutProfile_profile_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
      ...
      courses_courses_instituteToinstitute: z
        .lazy(
          () =>
            coursesUncheckedUpdateManyWithoutInstitute_courses_instituteToinstituteNestedInputObjectSchema
        )
        .optional(),
...
export const instituteUncheckedUpdateWithoutProfile_profile_instituteToinstituteInputObjectSchema =
  Schema
