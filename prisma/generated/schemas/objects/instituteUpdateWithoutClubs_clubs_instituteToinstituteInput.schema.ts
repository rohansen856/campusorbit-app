...
const Schema: z.ZodType<Prisma.instituteUpdateWithoutClubs_clubs_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
...
export const instituteUpdateWithoutClubs_clubs_instituteToinstituteInputObjectSchema =
  Schema
