...
const Schema: z.ZodType<Prisma.instituteUncheckedCreateWithoutRoutine_routine_instituteToinstituteInput> =
  z
    .object({
...
export const instituteUncheckedCreateWithoutRoutine_routine_instituteToinstituteInputObjectSchema =
  Schema
