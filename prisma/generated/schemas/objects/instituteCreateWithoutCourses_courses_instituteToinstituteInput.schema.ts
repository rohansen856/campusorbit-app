...
const Schema: z.ZodType<Prisma.instituteCreateWithoutCourses_courses_instituteToinstituteInput> =
  z
    .object({
...
export const instituteCreateWithoutCourses_courses_instituteToinstituteInputObjectSchema =
  Schema
