...
const Schema: z.ZodType<Prisma.instituteCreateWithoutMess_mess_instituteToinstituteInput> =
  z
    .object({
...
export const instituteCreateWithoutMess_mess_instituteToinstituteInputObjectSchema =
  Schema
