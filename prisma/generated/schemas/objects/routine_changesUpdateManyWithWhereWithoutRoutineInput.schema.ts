...
const Schema: z.ZodType<Prisma.routine_changesUpdateManyWithWhereWithoutRoutineInput> =
  z
    .object({
...
export const routine_changesUpdateManyWithWhereWithoutRoutineInputObjectSchema =
  Schema
