...
const Schema: z.ZodType<Prisma.profileUncheckedCreateWithoutAnalyticsInput> = z
  .object({
    id: z.string(),
...
export const profileUncheckedCreateWithoutAnalyticsInputObjectSchema = Schema
