...
const Schema: z.ZodType<Prisma.profileUncheckedUpdateOneWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const profileUncheckedUpdateOneWithoutAccountNestedInputObjectSchema =
  Schema
