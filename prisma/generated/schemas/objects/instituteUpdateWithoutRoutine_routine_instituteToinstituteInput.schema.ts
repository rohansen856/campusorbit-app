...
const Schema: z.ZodType<Prisma.instituteUpdateWithoutRoutine_routine_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
...
export const instituteUpdateWithoutRoutine_routine_instituteToinstituteInputObjectSchema =
  Schema
