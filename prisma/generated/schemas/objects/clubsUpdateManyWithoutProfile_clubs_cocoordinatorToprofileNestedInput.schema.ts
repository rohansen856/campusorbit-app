...
const Schema: z.ZodType<Prisma.clubsUpdateManyWithoutProfile_clubs_cocoordinatorToprofileNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsUpdateManyWithoutProfile_clubs_cocoordinatorToprofileNestedInputObjectSchema =
  Schema
