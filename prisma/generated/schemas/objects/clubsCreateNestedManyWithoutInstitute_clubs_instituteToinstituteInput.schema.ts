...
const Schema: z.ZodType<Prisma.clubsCreateNestedManyWithoutInstitute_clubs_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const clubsCreateNestedManyWithoutInstitute_clubs_instituteToinstituteInputObjectSchema =
  Schema
