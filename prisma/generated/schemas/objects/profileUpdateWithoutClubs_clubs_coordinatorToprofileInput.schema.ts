...
const Schema: z.ZodType<Prisma.profileUpdateWithoutClubs_clubs_coordinatorToprofileInput> =
  z
    .object({
      username: z
        .union([
...
export const profileUpdateWithoutClubs_clubs_coordinatorToprofileInputObjectSchema =
  Schema
