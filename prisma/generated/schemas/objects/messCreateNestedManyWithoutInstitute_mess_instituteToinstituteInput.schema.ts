...
const Schema: z.ZodType<Prisma.messCreateNestedManyWithoutInstitute_mess_instituteToinstituteInput> =
  z
    .object({
      create: z
        .union([
...
export const messCreateNestedManyWithoutInstitute_mess_instituteToinstituteInputObjectSchema =
  Schema
