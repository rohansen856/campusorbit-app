...
const Schema: z.ZodType<Prisma.instituteUpdateWithoutCourses_courses_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
...
export const instituteUpdateWithoutCourses_courses_instituteToinstituteInputObjectSchema =
  Schema
