...
const Schema: z.ZodType<Prisma.messUncheckedUpdateManyWithoutInstitute_mess_instituteToinstituteNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const messUncheckedUpdateManyWithoutInstitute_mess_instituteToinstituteNestedInputObjectSchema =
  Schema
