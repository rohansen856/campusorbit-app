...
const Schema: z.ZodType<Prisma.routine_changesCreateNestedManyWithoutAccountInput> =
  z
    .object({
      create: z
        .union([
...
export const routine_changesCreateNestedManyWithoutAccountInputObjectSchema =
  Schema
