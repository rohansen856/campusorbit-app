...
const Schema: z.ZodType<Prisma.routine_changesUpdateManyWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const routine_changesUpdateManyWithoutAccountNestedInputObjectSchema =
  Schema
