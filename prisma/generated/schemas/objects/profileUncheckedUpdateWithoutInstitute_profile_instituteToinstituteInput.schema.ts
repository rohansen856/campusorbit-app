...
const Schema: z.ZodType<Prisma.profileUncheckedUpdateWithoutInstitute_profile_instituteToinstituteInput> =
  z
    .object({
      id: z
        .union([
...
export const profileUncheckedUpdateWithoutInstitute_profile_instituteToinstituteInputObjectSchema =
  Schema
