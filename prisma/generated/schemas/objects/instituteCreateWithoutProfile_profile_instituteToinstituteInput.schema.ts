...
const Schema: z.ZodType<Prisma.instituteCreateWithoutProfile_profile_instituteToinstituteInput> =
  z
    .object({
...
export const instituteCreateWithoutProfile_profile_instituteToinstituteInputObjectSchema =
  Schema
