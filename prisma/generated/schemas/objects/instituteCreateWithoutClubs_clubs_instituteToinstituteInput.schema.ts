...
const Schema: z.ZodType<Prisma.instituteCreateWithoutClubs_clubs_instituteToinstituteInput> =
  z
    .object({
...
export const instituteCreateWithoutClubs_clubs_instituteToinstituteInputObjectSchema =
  Schema
