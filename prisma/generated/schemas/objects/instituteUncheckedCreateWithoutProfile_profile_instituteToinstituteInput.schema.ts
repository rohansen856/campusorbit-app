...
const Schema: z.ZodType<Prisma.instituteUncheckedCreateWithoutProfile_profile_instituteToinstituteInput> =
  z
    .object({
...
export const instituteUncheckedCreateWithoutProfile_profile_instituteToinstituteInputObjectSchema =
  Schema
