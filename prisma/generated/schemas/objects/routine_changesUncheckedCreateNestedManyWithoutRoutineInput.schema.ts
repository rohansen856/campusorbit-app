...
const Schema: z.ZodType<Prisma.routine_changesUncheckedCreateNestedManyWithoutRoutineInput> =
  z
    .object({
      create: z
        .union([
...
export const routine_changesUncheckedCreateNestedManyWithoutRoutineInputObjectSchema =
  Schema
